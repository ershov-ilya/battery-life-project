...
var JP={
  ...
  personal_data: '[設定]',
  battery_status:'あなたのバッテリーの状態',
  battery:'バッテリー',
  user_profile:'ユーザーのプロフィール',

  // Анкета
  fill_profile:'プロフィールを記入',
  clarify_data:'データの明確化',
  your_birthday_date:'あなたの誕生日の日付',
  Choose_your_gender:'あなたの性別を選択してください：',
  male:'マレ',
  female:'女性',
  ...
  // Дополнительные опции
  no:'ノー',
  Do_you_smoke:'タバコは吸いますか？',
  smoking_1_10:'一日あたり1-9タバコ',
  smoking_10_30:'10-30タバコ日',

  alko:'習慣を飲む？',
  alko_no:'絶対にありません',
  alko_events:'時折、イベントによって',
  alko_1_2:'時には、夕方に1〜2人前',
  alko_partyman:'時間は友達と過ごしている間',
  alkoholic:'国外認めざるを得ない - 私はアルコールだ',

  sport:'物理的な演習？',
  sport_no:'ノー',
  sport_20min:'定期的に、20分の日',
  sport_1hour:'日定期的に、時間',
  ...
  coffee:'コーヒーを飲む？',
  coffee_no:'ノー',
  coffee_1_2:'定期的に、1〜2カップの日',
  coffee_3_4:'定期的に、3〜4カップの日',
  ...
  hint:'ヒント:',
  hint1:'あなたが別の国に住んでいた場合には、お使いのバッテリーをどのように見えるかを確認するために、たとえば、ユーザー·プロファイル内の異なる値を試すことができます。',
  hint2:'それとも、あなたの家族からの誰かのデータを入力することができます。',
  content:'コンテンツ'
};
